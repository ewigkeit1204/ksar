...
public class Config {
	...
	private static void load() {
		...
		byte[] buf = myPref.getByteArray("LinuxDateFormat", null);
		if (buf == null) {
			setLinuxDateFormat(Linux.DateFormat.ALWAYS_ASK);
		} else {
			try (ByteArrayInputStream bais = new ByteArrayInputStream(buf);
					ObjectInputStream ois = new ObjectInputStream(bais)) {
				Linux.DateFormat format = (Linux.DateFormat) ois.readObject();
				setLinuxDateFormat(format);
	...
	public static void save() {
		...
		try (ObjectOutputStream oos = new ObjectOutputStream(baos)) {
			oos.writeObject(LinuxDateFormat);
		} catch (IOException e) {
			// ignore
		}
		myPref.putByteArray("LinuxDateFormat", baos.toByteArray());
	...
	public static Linux.DateFormat getLinuxDateFormat() {
		return LinuxDateFormat;
	}

	public static void setLinuxDateFormat(Linux.DateFormat LinuxDateFormat) {
	...
	private static Linux.DateFormat LinuxDateFormat;
